...
function addTodo() {
  ...
  .post('https://jsonplaceholder.typicode.com/todos',{
    title : "newUSerFromVsCode",
    job : "Doing post request"
  })
  .then(res => showOutput(res))
  .catch(err => console.error(err))
}
...
function updateTodo() {
  axios.put('https://jsonplaceholder.typicode.com/todos/1',{
    name : "Kiran has been updated from his unique id",
    email : "His email also updated",
    phone_num : "from 89900883772 to 99997777888"
  })
  .then(res => showOutput(res))
  .catch(err => console.error(err))
}
...
function errorHandling() {
  ...
  .catch(err => {
    if(err.response){
      ...
      //Request was mad but no response
